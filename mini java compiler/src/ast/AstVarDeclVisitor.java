...
public class AstVarDeclVisitor implements Visitor {
	...
	public AstVarDeclVisitor(String className, String ogName,String newName, String methName, int lnumber) {
    ...
    public void visit(MethodDecl methodDecl) {
        ...
        for (var varDecl : methodDecl.vardecls()) {
            if (varDecl.name().equals(ogName) && varDecl.lineNumber == lnumber) {
